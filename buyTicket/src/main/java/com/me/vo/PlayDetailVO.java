...
public class PlayDetailVO {
    ...
    public PlayDetailVO(String playId, String playTimeStr, String lanType, BigDecimal price, String roomId, String roomName, String filmId, String filmName, String seat) {
        this.playId = playId;
